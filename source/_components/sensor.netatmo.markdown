...
If the **lastupdated** sensor is declared, the platform will synchronize its updates with the NetAtmo cloud, so to have the freshest data available. This may be useful for improving the reactivity of automations.
